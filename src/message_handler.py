...
replacement_lamp = """<i>Вы в меню замены лампы. Следуйте инструкциям на экране</i>"""

# get menu
get_stock_device = """<i>Вы в меню вывода на экран приборов на складе по ID. Следуйте инструкциям на экране</i>"""

get_broken_device = """<i>Вы в меню вывода на экран приборов в ремонте за определенную дату. Следуйте инструкциям на экране</i>"""
...
mark_device = """<i>Вы можете поместить прибор в ремонт или вывести из ремонта. Следуйте инструкциям на экране</i>"""

stock_device_at_date = (
    """<i>Вы в меню вывода на экран информации о приборах за определенную дату</i>"""
)

check_lamp_hours = """<i>Вы в меню расчета ресурса лампы</i>"""
...
BUTTON_DESCRIPTION = {
    ...
    "/get_broken_device": get_broken_device,
    "/get_devices": get_devices,
    "/get_types": get_types,
    "/mark_device": mark_device,
    "/stock_device_at_date": stock_device_at_date,
